      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Kit Library</h1>
        ...
        {kits.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Add .mdx files to the content/kits directory to see them here.
            </p>
          </div>
        ) : (
          <>
      ...
      <footer className="mt-20 border-t bg-white/50">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-muted-foreground text-sm">
            <p>Built with Next.js and MDX • Add your own kits to get started</p>
          </div>
        </div>
      </footer>
    </div>
